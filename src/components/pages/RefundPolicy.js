...
const RefundPolicyTextWrapper = styled.div`
  width: 90%;
  margin: 0 5%;
  padding-top: 30vw;
`;
...
export default class RefundPolicy extends Component {
  ...
  RefundPolicy = () => {
    return {
      ...
      <p>If you’ve done all of this and you still have not received your refund yet, please contact us at jandrewbutler.93@gmail.com.</p>
      <p></p>
      <p>Sale items (if applicable)</p>
      <p>Only regular priced items may be refunded, unfortunately sale items cannot be refunded.</p>
      <p></p>
      <p>Exchanges (if applicable)</p>
      <p>We only replace items if they are defective or damaged.  If you need to exchange it for the same item, send us an email at jandrewbutler.93@gmail.com and send your item to: 94 Mowbray Rd, Willloughby, Sydney, NSW, 2068, Australia.</p>
      <p></p>
      <p>Gifts</p>
      ...
      <p></p>
      <p>Shipping</p>
      <p>To return your product, you should mail your product to: 94 Mowbray Rd, Willloughby, Sydney, NSW, 2068, Australia.</p>
      <p></p>
