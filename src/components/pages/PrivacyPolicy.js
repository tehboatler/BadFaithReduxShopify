...
const PrivacyPolicyTextWrapper = styled.div`
  width: 90%;
  margin: 0 5%;
  padding-top: 30vw;
`;
...
export default class PrivacyPolicy extends Component {
  PrivacyPolicy = () => {
    return {
      ...
      <div class="container">
      <p>StarSigned Privacy Policy</p>
      <p></p>
      <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from www.starsignedstyle.com (the “Site”).</p>
      <p></p>
      ...
      <p></p>
      <p>DATA RETENTION</p>
      <p>When you place an order through the Site, we will maintain your Order Information for our records unless and until you ask us to </p>
      <p></p>
      <p></p>
      <p>CHANGES</p>
      ...
      <p></p>
      <p>CONTACT US</p>
      <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e-mail at support@starsignedstyle.com or by mail using the details provided below:</p>
      <p></p>
      <p>  94 Mowbray Rd, Willoughby, Sydney, NSW, 2068, Australia</p>
      </div>`
    };
  };
